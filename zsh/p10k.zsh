# Generated by Powerlevel10k configuration wizard on 2026-01-27 at 20:51 PST.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND='#2cf9ed'
  # Red prompt symbol if the last command failed.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND='#ff2453'
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND='#af87ff'
  # Default current directory foreground color.
  typeset -g POWERLEVEL9K_DIR_FOREGROUND='#2b1d45'
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND='#4a3a6e'
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND='#1a1026'
  ...
  typeset -g POWERLEVEL9K_VCS_CONFLICTED_BACKGROUND='#004d6b'
  typeset -g POWERLEVEL9K_VCS_LOADING_BACKGROUND='#004d6b'
  ...
  # The icon below is U+F00C (nf-fa-check), not U+2714 '✔' — Hack Nerd Font has
  # no glyph for U+2714, so fontconfig fell back to FreeSerif and drew it
  # oversized and off the cell grid. U+F00D replaces U+2718 in the error states
  # for the same reason. These must be literal characters: unlike the _ICON
  # settings (see BRANCH_ICON above), VISUAL_IDENTIFIER_EXPANSION is only
  # prompt-expanded, so a '\uXXXX' escape prints verbatim instead of a glyph.
  typeset -g POWERLEVEL9K_STATUS_OK=true
  typeset -g POWERLEVEL9K_STATUS_OK_VISUAL_IDENTIFIER_EXPANSION=''
  typeset -g POWERLEVEL9K_STATUS_OK_FOREGROUND='#1dfca1'
  typeset -g POWERLEVEL9K_STATUS_OK_BACKGROUND='#004d6b'

  # Status when some part of a pipe command fails but the overall exit status is zero. It may look
  # like this: 1|0.
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE=true
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_VISUAL_IDENTIFIER_EXPANSION=''
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_FOREGROUND='#1dfca1'
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_BACKGROUND='#004d6b'
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_BACKGROUND='#ff2453'
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL_BACKGROUND='#ff2453'
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_BACKGROUND='#ff2453'

  ###################[ command_execution_time: duration of the last command ]###################
  # Execution time color.
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND='#af87ff'
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_BACKGROUND='#004d6b'
  ...
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_FOREGROUND='#af87ff'
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_BACKGROUND='#004d6b'
  ...
  #######################[ direnv: direnv status (https://direnv.net/) ]########################
  # Direnv color.
  typeset -g POWERLEVEL9K_DIRENV_FOREGROUND='#f97716'
  typeset -g POWERLEVEL9K_DIRENV_BACKGROUND='#004d6b'
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_TIMEWARRIOR_BACKGROUND=254
